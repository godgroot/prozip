...
async def start(bot, update):
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton
                                (
                                    '📀 OTT & DVD UPDATES 📀', url=f"{CINEMAZIPNEWS}"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🔱Join🔱', url=f'{CINEMAZIPLINKS}'),
        InlineKeyboardButton('📀OTT UPDATES📀', url=f'{CINEMAZIPNEWS}')
    ],[
        InlineKeyboardButton('⚜️CLICK HERE⚜️', url='https://t.me/share/url?url=https://t.me/cinemazip')
    ]]
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 ASHAAN ashaan❌', url='https://t.me/Im_godgroot'),
        InlineKeyboardButton('Skp KP👤', url='https://t.me/Skp_Kp')
    ],[
        InlineKeyboardButton('🔰 JOIN AT CINEMAZIP🔰', url='https://t.me/CINEMAZIP')
    ],[
